  ...
  return (
    <div style={{ background: "var(--paper)", color: "var(--ink)" }} className="min-h-screen">
      ...
      <div className="sans">
        ...
        {/* About Hero */}
        <section className="relative border-b" style={{ borderColor: "var(--rule)" }}>
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 relative z-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="mono text-[11px] tracking-widest uppercase" style={{ color: "var(--green)" }}>
                Debsphere Academy
              </span>
            </div>
            ...
            <p className="mt-6 text-lg max-w-2xl leading-relaxed" style={{ color: "#4B5768" }}>
        ...
        {/* Our Story / Vision */}
        <section className="max-w-6xl mx-auto px-6 py-20 border-b" style={{ borderColor: "var(--rule)" }}>
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="mt-5 space-y-4 leading-relaxed" style={{ color: "#4B5768" }}>
                <p>
                  The journey began when a friend asked to be taught how to
                  use Microsoft Excel for data cleaning. While preparing to
                  guide him, one realization stood out: if one person needed
                  this knowledge, countless others could benefit from it too.
                </p>
                <p>
                  Instead of teaching just one person, the opportunity opened
                  to anyone willing to learn. That decision led to the launch
                  of the very first cohort of Debsphere Academy — what started
                  as a small training session soon became a thriving learning
                  community.
                </p>
                <p>
              ...
              <div className="mt-6 pt-4 border-t" style={{ borderColor: "var(--rule)" }}>
                <p className="text-sm mono" style={{ color: "var(--ink)" }}>Deborah Olabode</p>
            ...
            <div>
              ...
              <h2 className="serif text-3xl font-semibold">Bridging the gap.</h2>
              ...
              <p className="mt-4 leading-relaxed" style={{ color: "#4B5768" }}>
                ...
                graduates with the confidence, competence, and experience
                needed to thrive.
              </p>
              <div className="mt-8 flex items-center gap-4 border p-5" style={{ borderColor: "var(--rule)", background: "var(--green-tint)" }}>
                <Target size={22} style={{ color: "var(--green)" }} strokeWidth={1.5} />
                <div>
                  <div className="font-medium text-sm" style={{ color: "var(--ink)" }}>Mission-driven</div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          <div className="border p-12 md:p-16 text-center" style={{ borderColor: "var(--rule)" }}>
            <Sparkles size={26} style={{ color: "var(--green)" }} className="mx-auto mb-5" strokeWidth={1.5} />
        ...
        {/* Footer */}
        <footer className="max-w-6xl mx-auto px-6 py-8 text-center mono text-xs" style={{ color: "#8A93A2" }}>
